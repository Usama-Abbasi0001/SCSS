...
export default function Signup() {
  ...
  useEffect(() => {
    if (adminExists === null || authLoading) return;
    // If an admin already exists and current user is not an admin, redirect to login
    if (adminExists && (!user || user.role !== 'admin')) {
      navigate('/login');
    }
